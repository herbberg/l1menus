...
algo(59) <= l1_single_jet8_bptx_and;
...
algo(25) <= l1_single_jet16_bptx_and;
...
algo(36) <= l1_single_jet20_bptx_and;
...
algo(48) <= l1_single_jet24_bptx_and;
...
algo(66) <= l1_single_jet8er1p3_bptx_and;
...
algo(56) <= l1_single_jet12er1p3_bptx_and;
...
algo(27) <= l1_single_jet16er1p3_bptx_and;
...
algo(38) <= l1_single_jet20er1p3_bptx_and;
...
algo(33) <= l1_double_eg2_bptx_and;
...
algo(57) <= l1_double_eg4er2p13_bptx_and;

-- 469 L1_DoubleEG2 : comb{EG2,EG2}
l1_double_eg2 <= double_eg_i462;
algo(30) <= l1_double_eg2;
