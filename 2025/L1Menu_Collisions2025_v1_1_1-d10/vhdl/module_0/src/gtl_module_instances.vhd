...
algo(43) <= l1_single_jet20er2p5_not_bptx_or_3_bx;
...
algo(47) <= l1_single_jet12_bptx_and;
...
algo(65) <= l1_single_jet16_bptx_and;
...
algo(30) <= l1_single_jet20_bptx_and;
...
algo(50) <= l1_single_jet12er1p3_bptx_and;
...
algo(68) <= l1_single_jet16er1p3_bptx_and;
...
algo(67) <= l1_double_eg2_bptx_and;
...
algo(28) <= l1_double_eg3_bptx_and;
...
algo(31) <= l1_double_eg3er2p13_bptx_and;
...
algo(35) <= l1_double_eg4_bptx_and;
...
algo(39) <= l1_double_eg4er2p13_bptx_and;

-- 469 L1_DoubleEG2 : comb{EG2,EG2}
l1_double_eg2 <= double_eg_i462;
algo(64) <= l1_double_eg2;
