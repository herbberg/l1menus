...
algo(12) <= l1_mu3er1p5_jet100er2p5_etmhf30;
...
algo(33) <= l1_double_mu3_sq_etmhf30_htt60er;
...
algo(38) <= l1_double_mu3_sq_etmhf40_htt60er;
...
algo(10) <= l1_double_mu3_sq_etmhf40_jet60er2p5_or_double_jet40er2p5;
...
algo(39) <= l1_double_eg_25_12_er2p5;
...
algo(8) <= l1_single_jet60er3p0to5p0;

-- 301 L1_SingleJet60 : JET60
l1_single_jet60 <= single_jet_i218;
algo(26) <= l1_single_jet60;
...
algo(43) <= l1_single_jet120_fwd2p5;
...
algo(87) <= l1_hcal_laser_mon_trig;
