...
algo(5) <= l1_double_mu5_sq_os_d_r_max1p6;
...
algo(54) <= l1_triple_mu_3_sq_2p5_sq_0;
...
algo(4) <= l1_triple_mu_3_sq_2p5_sq_0_mass_max12;

-- 121 L1_TwoMuShower_Loose : MUS2
l1_two_mu_shower_loose <= muon_shower2_i335;
algo(94) <= l1_two_mu_shower_loose;
...
algo(31) <= l1_mu3er1p5_jet100er2p5_etmhf30;
...
algo(15) <= l1_double_mu3_sq_etmhf30_htt60er;
...
algo(55) <= l1_loose_iso_eg14er2p5_htt200er;
...
algo(56) <= l1_loose_iso_eg16er2p5_htt200er;
...
algo(30) <= l1_single_jet60er3p0to5p0;
...
algo(9) <= l1_etmhf80_single_jet55er2p5_d_phi_min2p1;
...
algo(10) <= l1_etmhf80_single_jet55er2p5_d_phi_min2p6;
...
algo(16) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p1;
...
algo(19) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p6;
...
algo(89) <= l1_bptx_beam_gas_ref1_vme;
