...
algo(42) <= l1_single_mu_cosmics_emtf;
...
algo(29) <= l1_single_mu0_upt10_omtf;
...
algo(23) <= l1_double_mu4_sq_eg9er2p5;
...
algo(3) <= l1_mu12er2p3_jet40er2p3_d_r_max0p4_double_jet40er2p3_d_eta_max1p6;

-- 177 L1_SingleEG28er1p3 : EG28[EG-ETA_1p3]
l1_single_eg28er1p3 <= single_eg_i473;
algo(13) <= l1_single_eg28er1p3;
...
algo(22) <= l1_single_loose_iso_eg28er1p3to2p5;
...
algo(14) <= l1_single_iso_eg28er1p3;
...
algo(11) <= l1_single_iso_eg28er1p3to2p5;
...
algo(21) <= l1_single_iso_eg28er2p5to3p0;
...
algo(5) <= l1_double_eg17_11_er1p2_d_r_max0p6;
...
algo(9) <= l1_double_iso_tau30er2p1;
...
algo(10) <= l1_double_iso_tau36er2p1;
...
algo(6) <= l1_double_tau_iso40_iso26_er2p1_jet55_rm_ovlp_d_r0p5;

-- 305 L1_SingleJet200 : JET200
l1_single_jet200 <= single_jet_i222;
algo(52) <= l1_single_jet200;
