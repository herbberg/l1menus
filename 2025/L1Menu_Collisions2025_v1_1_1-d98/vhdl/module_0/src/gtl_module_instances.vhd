...
algo(30) <= l1_double_mu0er2p0_sq_d_eta_max1p6;
...
algo(29) <= l1_double_mu0er2p0_sq_os_d_eta_max1p5;
...
algo(28) <= l1_double_mu0er1p4_sq_os_d_eta_max1p2;
...
algo(27) <= l1_triple_mu_4_sq_2p5_sq_0_os_mass_max12;
...
algo(23) <= l1_double_jet16er2p5_mu3_d_r_max0p4;
...
algo(24) <= l1_double_jet80er2p5_mu3_d_r_max0p4;
...
algo(36) <= l1_single_iso_eg28_fwd2p5;
...
algo(25) <= l1_double_eg15_11_er1p2_d_r_max0p6;
...
algo(26) <= l1_double_tau_iso34_iso26_er2p1_jet70_rm_ovlp_d_r0p5;
...
algo(20) <= l1_double_jet30er2p5_mass_min225_d_eta_max1p5;
...
algo(82) <= l1_single_jet16_bptx_and;
...
algo(62) <= l1_single_jet24_bptx_and;
...
algo(68) <= l1_single_jet12er1p3_bptx_and;
...
algo(40) <= l1_single_jet16er1p3_bptx_and;
...
algo(51) <= l1_single_jet20er1p3_bptx_and;
...
algo(46) <= l1_double_eg2_bptx_and;
...
algo(53) <= l1_double_eg2er2p13_bptx_and;
...
algo(57) <= l1_double_eg3_bptx_and;
...
algo(59) <= l1_double_eg3er2p13_bptx_and;
...
algo(65) <= l1_double_eg4_bptx_and;
