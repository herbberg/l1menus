...
algo(54) <= l1_mu7_loose_iso_eg23er2p5;
...
algo(40) <= l1_double_mu3_sq_etmhf30_htt60er;
...
algo(45) <= l1_double_mu3_sq_etmhf40_jet60er2p5_or_double_jet40er2p5;
...
algo(34) <= l1_single_jet60er1p3to2p5;
...
algo(36) <= l1_single_jet60er2p5to3p0;
...
algo(38) <= l1_single_jet60er3p0to5p0;

-- 301 L1_SingleJet60 : JET60
l1_single_jet60 <= single_jet_i219;
algo(25) <= l1_single_jet60;
...
algo(18) <= l1_etmhf80_single_jet55er2p5_d_phi_min2p1;
...
algo(30) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p1;
