...
constant global_index: global_index_array := (
        ...
        446, -- module_index: 22, name: L1_SingleJet16_BptxAND
        451, -- module_index: 23, name: L1_SingleJet16er1p3_BptxAND
        472, -- module_index: 24, name: L1_AlwaysTrue
        441, -- module_index: 25, name: L1_SingleJet43er2p5_NotBptxOR_3BX
        442, -- module_index: 26, name: L1_SingleJet46er2p5_NotBptxOR_3BX
        473, -- module_index: 27, name: L1_ZeroBias
        487, -- module_index: 28, name: L1_SecondBunchInTrain
        474, -- module_index: 29, name: L1_ZeroBias_copy
        ...
        463, -- module_index: 34, name: L1_DoubleEG2_BptxAND
        452, -- module_index: 35, name: L1_SingleJet20er1p3_BptxAND
        ...
        466, -- module_index: 47, name: L1_DoubleEG3er2p13_BptxAND
        ...
        467, -- module_index: 53, name: L1_DoubleEG4_BptxAND
        ...
        477, -- module_index: 59, name: L1_NotBptxOR
        438, -- module_index: 60, name: L1_SingleMuOpen_er1p1_NotBptxOR_3BX
        489, -- module_index: 61, name: L1_LastBunchInTrain
        460, -- module_index: 62, name: L1_SingleEG7
        449, -- module_index: 63, name: L1_SingleJet8er1p3_BptxAND
        437, -- module_index: 64, name: L1_SingleMuOpen_er1p4_NotBptxOR_3BX
        458, -- module_index: 65, name: L1_SingleEG7_BptxAND
        478, -- module_index: 66, name: L1_BptxOR
