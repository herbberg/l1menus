...
algo(23) <= l1_double_mu3_sq_etmhf40_htt60er;
...
algo(12) <= l1_double_mu3_sq_etmhf30_jet60er2p5_or_double_jet40er2p5;
...
algo(11) <= l1_double_eg15_er1p5_d_eta_max1p5;
...
algo(9) <= l1_double_tau_iso34_iso26_er2p1_jet70_rm_ovlp_d_r0p5;

-- 297 L1_SingleJet60er1p3 : JET60[JET-ETA_1p3]
l1_single_jet60er1p3 <= single_jet_i468;
algo(14) <= l1_single_jet60er1p3;
...
algo(18) <= l1_single_jet60er1p3to2p5;
...
algo(21) <= l1_single_jet60er2p5to3p0;
...
algo(24) <= l1_single_jet60er3p0to5p0;
...
algo(41) <= l1_etmhf80_single_jet55er2p5_d_phi_min2p6;
...
algo(15) <= l1_etmhf90_single_jet60er2p5_d_phi_min2p1;
...
algo(74) <= l1_htt160_single_llp_jet50;
