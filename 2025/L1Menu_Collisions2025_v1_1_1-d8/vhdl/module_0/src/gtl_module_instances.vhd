...
-- selector same/different bunch crossings
    ...
    port map(
        ...
        dr_orm => jet_tau_bx_0_bx_0_dr,
        mass_inv_pt => jet_tau_bx_0_bx_0_mass_inv_pt,
...
algo(25) <= l1_double_mu0er2p0_sq_d_eta_max1p6;
...
algo(21) <= l1_double_mu0er1p4_sq_os_d_eta_max1p2;
...
algo(100) <= l1_single_mu_shower_tight;
...
algo(34) <= l1_double_loose_iso_eg22er2p1;
...
algo(8) <= l1_double_tau_iso38_iso26_er2p1_jet55_rm_ovlp_d_r0p5;
...
algo(9) <= l1_double_tau_iso40_iso26_er2p1_jet55_rm_ovlp_d_r0p5;
...
algo(7) <= l1_double_tau_iso34_iso26_er2p1_jet70_rm_ovlp_d_r0p5;
...
algo(81) <= l1_single_mu_open_er1p1_not_bptx_or_3_bx;
...
algo(77) <= l1_single_jet8_bptx_and;
...
algo(67) <= l1_single_jet12_bptx_and;
...
algo(43) <= l1_single_jet16_bptx_and;
...
algo(54) <= l1_single_jet20_bptx_and;
...
algo(66) <= l1_single_jet24_bptx_and;
...
algo(39) <= l1_single_jet8er1p3_bptx_and;
...
algo(74) <= l1_single_jet12er1p3_bptx_and;
...
algo(45) <= l1_single_jet16er1p3_bptx_and;
...
algo(56) <= l1_single_jet20er1p3_bptx_and;
...
algo(41) <= l1_single_eg7_bptx_and;
...
algo(51) <= l1_double_eg2_bptx_and;
...
algo(58) <= l1_double_eg2er2p13_bptx_and;
...
algo(61) <= l1_double_eg3_bptx_and;
...
algo(64) <= l1_double_eg3er2p13_bptx_and;
...
algo(98) <= l1_first_collision_in_orbit;
